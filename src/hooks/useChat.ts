...
export const useChat = () => {
  ...
  const askQuestion = useCallback(async (question: string, apiKey: string) => {
  ...
  }, [isLoading, displayUserMessage, buildChatHistoryForAPI, updateLastMessage, saveMessageToHistory]);
