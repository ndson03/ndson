    ...
    <div className="flex justify-start animate-[fadeIn_0.3s_ease-in]">
      <div className="relative w-10 h-10 flex-shrink-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-9 h-9">
          <svg
            className="absolute inset-0 w-full h-full animate-[spin_1.2s_cubic-bezier(0.4,0,0.6,1)_infinite]"
            viewBox="0 0 50 50"
          >
            <defs>
              <linearGradient
              ...
              >
                ...
                <stop offset="20%" stopColor="#D84A3F" />
                <stop offset="40%" stopColor="#C85C38" />
                <stop offset="60%" stopColor="#2A9D8F" />
                <stop offset="80%" stopColor="#277DA1" />
